...
in Bavaria, Germany.
See the [conference](https://eplus.uni-salzburg.at/agit/periodical/titleinfo/12103771)
and [journal](https://gispoint.de/artikelarchiv/gis/2025/gisscience-ausgabe-42025/8692-kartierung-von-windpotenzialgebieten-in-bayern.html)
...
on eligible areas for wind turbines in Bavaria through [GLAES](https://github.com/FZJ-IEK3-VSA/glaes)-based eligibility
analyses.
In detail, the distance to residential buildings is increased from 0 to 2000 metres in three scenarios: Unrestricted
forest use, restricted forest use according to
the [forest function mapping](https://www.stmelf.bayern.de/wald/wald_mensch/waldfunktionsplanung-in-bayern/index.html)
...
````
 @article{Stengel_Mitterhofer_2025,
    title = {Mapping wind potential areas in Bavaria, Germany},
    pages = {142--146},
    number = {4},
    journal = {gis.Science},
    doi = {10.14627/gis.Science.2025.4.4},
    author = {Stengel, Martin and Mitterhofer, Matthias},
    year = {2025}
 }
